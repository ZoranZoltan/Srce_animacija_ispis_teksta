...
(function() {
  ...
  styles = `/* 
 * Robotski ispis koda verzija 1.0.0🎣
 * Automatski grafički raster
 * Autor Zoran Zoltan Kurešević
 */
 ...
 * ...?            
 *
 * Zdravo Sneki. To sam ja Zoran.         
 *
 * Samo sedim pored tebe i kodiram nešto.            
 *
 * Naravno, možeš da gledaš.                       
 *
 *
 * Ovaj CSS se ubacuje u DOM <style> element
* i nalazi se u ovom <pre> js elementu istovremeno.        
 *
 * Zbunjena? Gledaj!
 *
 */
...
/* 
 * Isticanje sintakse (highlight),
* Boje se temeljene na Basi16 Ocean Dark...
 */
...
/* 
 * krenimo da gradimo ono što želim da ti dam.
 */ 


/* Prvo da premestimo ovaj tekst da ne smeta... */
...
/* 
 * Da li ti se svidja? Sada ga trebamo pokrenuti...
 */
 ...
 * Uspeli smo!       
 *
 * Mislim ja sam uspeo, ali znaš i sama...
 * Da nema tebe ne bi imao kome da poklonim srce...
 *
 * Ono je sada tvoje...     
 * 
 * LJUBIM TE!
...
<pre id="style-text"></pre>`);
  ...
  time = window.innerWidth <= 578 ? 8 : 32;
